 ...
 */
class PerfilTratamento extends \TenilUser\Entity\PerfilTratamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'TenilUser\\Entity\\PerfilTratamento' . "\0" . 'id', '' . "\0" . 'TenilUser\\Entity\\PerfilTratamento' . "\0" . 'nome', '' . "\0" . 'TenilUser\\Entity\\PerfilTratamento' . "\0" . 'abreviacao');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PerfilTratamento $proxy) {
