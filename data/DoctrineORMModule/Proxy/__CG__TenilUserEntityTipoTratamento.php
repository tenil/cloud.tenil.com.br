 ...
 */
class TipoTratamento extends \TenilUser\Entity\TipoTratamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'TenilUser\\Entity\\TipoTratamento' . "\0" . 'id', '' . "\0" . 'TenilUser\\Entity\\TipoTratamento' . "\0" . 'nome', '' . "\0" . 'TenilUser\\Entity\\TipoTratamento' . "\0" . 'abreviacao');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoTratamento $proxy) {
